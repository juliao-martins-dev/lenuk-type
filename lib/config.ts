export const STORAGE_KEYS = {
  ...
  contentSeed: "lenuk-content-seed",
  firstVisitAt: "lenuk-first-visit-at",
  splashSeen: "lenuk-splash-seen",
  userStats: "lenuk-user-stats-v1"
} as const;

export const DEFAULT_SEED = "lenuk-type";
